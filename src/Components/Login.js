...
export const Login = () => {
        ...
        const submitData = async (event) => {
          ...
          if (userName && password && repeatPassword && emailAddress) {
            const res = fetch(
              "https://database-58bc3-default-rtdb.firebaseio.com/userDataRecords.json",
              {
                method: "POST",
                headers: {
                  ...
                  <input id="tab-2" type="radio" name="tab"  class="sign-up"/><label for="tab-2" class="tab" style={{cursor:'pointer'}}>Sign Up</label>
                      <div class="login-space">
                          <div class="login">
                              ...
                              <div class="group"> <input type="submit" class="button" style={{cursor:'pointer'}} value="Sign in"  /></div>
                              <div class="hr"></div>
                          ...
                          <div class="sign-up-form">
                              ...
                              <div class="group"> <input type="submit" class="button" style={{cursor:'pointer'}} onClick={submitData}  /></div>
                              <div class="hr"></div>
